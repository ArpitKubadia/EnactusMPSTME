		...
		<div id="site-content">
			...
			<main class="main-content">
				...
				<div class="fullwidth-block content">
					<div class="container">
						<h2 class="entry-title">You can write to us by filling the form below, or use the contact details provided : </h2>

						<div class="row">
							<div class="col-md-5">
								<form method="post" class="contact-form" action="https://formspree.io/aksharsharma13@gmail.com">
